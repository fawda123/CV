...
2026: \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Ocean and Coastal Management}
...
\item DeValpine, P., \textbf{Beck, M.W.} 2026. splinemixmeta: Additive mixed-meta analysis with spline meta-regression. v1.0.0. CRAN R package. ({\footnotesize\href{https://cran.r-project.org/web/packages/splinemixmeta/index.html}{link}})
