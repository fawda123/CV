...
% \item Otim, O., \textbf{Beck, M.W.} \textbf{In review}. Multivariate analysis of sediment toxicity in an ocean ecosystem: A Southern California Bight case study. \textit{Proceedings of the National Academy of Sciences}.

\item Sun, H., Le, C., Long, S., \textbf{Beck, M.W.} \textbf{In review}. Linking phytoplankton variability to atmospheric blocking in an eastern boundary upwelling system. \textit{Environmental Research Letters}. 

\item Raulerson, G.E., Robison, D.E., \textbf{Beck, M.W.}, Burke, M.C., Ries, T.F., Saarinen, J.A., Sciarrino, C.M., Sherwood, E.T., Tomasko, D.A. \textbf{In review}. Seizing diminishing habitat conservation and restoration opportunities in the Tampa Bay, FL watershed: An urban estuary in recovery. \textit{PLOS One}.

\item Bednar\v{s}ek, N., \textbf{Beck, M.W.}, Applebum, S.L., Feely, R.A., Pelletier, G., Butler, R., Byrne, M., Peabody, B., Davis, J., \v{S}trus, J. \textbf{In review}. The range of fluctuations, rather than pH decline, define biological responses of the native {O}lympia and introduced {P}acific oysters under current estuarine-related coastal acidification. \textit{Science of the Total Environment}.

\item Wessel, M.R., Leverone, J.R., \textbf{Beck, M.W.}, Sherwood, E.T., Hecker, J., West, S., Janicki, A. \textbf{In review}. A nutrient-based framework for tidal creeks in Southwest Florida. \textit{Estuaries and Coasts}.  

\item Meyers, S., Landry, S., \textbf{Beck, M.W.}, Luther, M. \textbf{In review}. Using logistic regression to model the risk of sewer overflows triggered by compound flooding with application to sea level rise. \textit{Urban Climate}. 

\item Rogers, J.B., Stein, E.D., \textbf{Beck, M.W.}, Flint, K., Kinoshita, A.M., Ambrose, R.F., \textbf{In review}. Modeling future changes to the hydrological and thermal regime of unaltered streams using projected changes in climate. \textit{Ecohydrology}.
...
\item Rogers, J.B., Stein, E.D., \textbf{Beck, M.W.}, Ambrose, R.F. \textbf{In press}. The impact of climate change induced alterations of streamflow and stream temperature on the distribution of riparian species. \textit{PLOS One}. 

\item Bednar\v{s}ek, N., Newton, J., \textbf{Beck, M.W.}, Alin, S.R., Feely, R.A., Christman, N., Klinger, T. \textbf{In press}. Severe biological effects under present-day estuarine acidification in the highly variable {S}alish {S}ea. \textit{Science of the Total Environment}. ({\footnotesize\href{https://doi.org/10.1016/j.scitotenv.2020.142689}{10.1016/j.scitotenv.2020.142689}})
...
\item \textbf{Beck, M.W.}, Schrandt, M., Wessel, M., Sherwood, E., Best, B. 2020. tbeptools: Data and Indicators for the Tampa Bay Estuary Program, v0.0.1. R package. ({\footnotesize\href{https://tbep-tech.github.io/tbeptools/}{link}})
