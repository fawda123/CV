...
2025: \textit{BioScience} $\bullet$ \textit{Environmental Science \& Technology} (2) $\bullet$ \textit{Estuaries and Coasts} (2) $\bullet$ \textit{Estuarine, Coastal and Shelf Science} $\bullet$ \textit{Journal of Geophysical Research - Oceans} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Restoration Ecology}
