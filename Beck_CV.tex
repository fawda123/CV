...
2026: \textit{BioScience} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Frontiers in Marine Science} $\bullet$ \textit{Ocean and Coastal Management}
