...
\item Le, C., Wu, S., \textbf{Beck, M.W.}, Yang, X. \textbf{In review}. Phytoplankton decline in the eastern {N}orth {P}acific transition zone associated with atmospheric blocking. \textit{Geophysical Research Letters}.

\item Bednar\v{s}ek, N., Feely, R.A., Alin, S.R., Nezlin, N.P., \textbf{Beck, M.W.}, Geeley, D., Saenger, C., Calosi, P., \v{S}trus, J., Spicer, J. \textbf{In review}. Carapace dissolution under natural low pH gradients represents a high-risk strategy for larval Dungeness crab sustainability. \textit{Nature Geoscience}. 
