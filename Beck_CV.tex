...
\item Le, C., Wu, S., Hu, C., \textbf{Beck, M.W.}, Yang, X. 2019. Phytoplankton decline in the eastern {N}orth {P}acific transition zone associated with atmospheric blocking. \textit{Global Change Biology}. {\footnotesize{\href{https://doi.org/10.1111/gcb.14737}{10.1111/gcb.14737}}}
...
\item Afrooz, N., \textbf{Beck, M.W.}, Hale, T., McKee, L., Schiff, K. 2019. BMP performance monitoring data compilation to support reasonable assurance analysis. Technical Report \#1081. Southern California Coastal Water Research Project. Costa Mesa, CA.
...
\item Bokde, N., \textbf{Beck, M.W.} 2019. imputeTestbench: Test bench for the comparison of imputation methods, v3.0.3. CRAN R package. (\href{https://cran.r-project.org/web/packages/imputeTestbench/index.html}{link})

\item \textbf{Beck, M.W.} 2019. SWMPr: An R package for the National Estuarine Research Reserve System, v2.3.1. CRAN R package. (\href{https://cran.r-project.org/web/packages/SWMPr/index.html}{link})

\item \textbf{Beck, M.W.}, Kittleson, K., O'Connor, K. 2019. Juvenile Stream Survey Habitat Web (JSSH web). (\href{https://sccwrp.shinyapps.io/jssh_web/}{link})

\item \textbf{Beck, M.W.}, Villarroel, P., Padfield, D. 2019. rStrava: Functions to access data from Strava's v3 API, v1.1.0. R package. (\href{https://github.com/fawda123/rStrava}{link})

\item \textbf{Beck, M.W.} 2019. ggord: A take on ordination plots with ggplot2, v1.1.4. R package. (\href{https://github.com/fawda123/ggord}{link})
...
\item \textbf{Beck, M.W.} 2018. NeuralNetTools: Visualization and Analysis Tools for Neural Networks, v1.5.2. CRAN R package. (\href{http://cran.r-project.org/web/packages/NeuralNetTools/}{link})
...
Janicki Enviromental, Inc. TBEP Tech Support Contract for Work Order 1 {\bf \$10600} \hfill {\bf May 2019} \\
...
Expert knowledge in open science tools and their application, including R, RStudio, R Shiny, Git, GitHub, \LaTeX, Sweave, knitr \\
