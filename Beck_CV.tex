...
2025: \textit{BioScience} $\bullet$ \textit{Environmental Science \& Technology} (2) $\bullet$ \textit{Estuaries and Coasts} (2) $\bullet$ \textit{Estuarine, Coastal and Shelf Science} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Restoration Ecology}
...
% \item de Valpine, P., Foley, M., \textbf{Beck, M.W.}, Senn, D.B. \textbf{In review}. Additive mixed meta-analysis with spline meta-regression for nonlinear ecological trends. \textit{Methods in Ecology and Evolution}.
