...
{\bf Statistics minor} \\
Converation Biology Graduate Program, University of Minnesota, Twin Cities, MN \\
...
\vspace{\baselineskip} 
\centerline{\large{\textit{Software}}}

\begin{enumerate}

\item \textbf{Beck, M.W.} 2015. WRTDStidal: Evaluating long-term chlorophyll trends in tidal waters. Version 0.0.4.9000. \href{https://github.com/fawda123/wtreg_for_estuaries}{https://github.com/fawda123/wtreg\_for\_estuaries}

\item \textbf{Beck, M.W.} 2015. SWMPr: An R package for the National Estuarine Research Reserve System. Version 2.0.0. \href{http://cran.r-project.org/web/packages/SWMPr/}{http://cran.r-project.org/web/packages/SWMPr/}

\item \textbf{Beck, M.W.} 2014. NeuralNetTools: Visualization and Analysis Tools for Neural Networks. Version 1.0.0. \href{http://cran.r-project.org/web/packages/NeuralNetTools/}{http://cran.r-project.org/web/packages/NeuralNetTools/}
...
NERRS/SWMP Data Analysis (Time-series) Workshop, System Wide Monitoring Program, National Estuarine Research Reserve System, NOAA, \url{http://copepod.org/nerrs-swmp-workshop/}

{\bf Workshop Co-Instructor} \hfill {\bf May 2013} \\
Using Available Software for Basic Analysis, Restoring Minnesota, University of Minnesota, \url{http://cceevents.umn.edu/restoring-minnesota/workshop}
...
Maintainer of GitHub repositories - \url{http://github.com/fawda123/} \\
Contributor for R-bloggers - \url{http://beckmw.wordpress.com/} \\
Co-maintainer for SWMP research and time series analysis website - \url{http://swmprats.net/} \\
