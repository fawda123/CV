...
Held post-doctorate research fellowship position in Oak Ridge Institute for Science and Education at USEPA Gulf Ecology Division, Ecosystem Dynamics and Effects Branch $\bullet$ Developed and applied statistical models of water quality measurements in coastal waters for trend analsysis and investigation of natural and anthropogenic drivers of ecosystem condition and function 
...
Developed an index of biotic integrity using aquatic macrophytes to determine the ecological health of Minnesota lakes $\bullet$ Developed remote sensing and image analysis techniques to quantify land use stressors from high-resolution aerial photos $\bullet$ Assisted researchers at the Minnesota Department of Natural Resources to develop appropriate methods for long-term lake monitoring program
...
Conducted creel surveys of anglers for catch and effort of black crappie (\textit{Pomoxis nigromaculatus}) $\bullet$ Collected laboratory analyses to support long-term monitoring program
...
{\bf Seminar Coordinator}, University of Minnesota \hfill {\bf spring 2009, fall 2009, fall 2011, spring 2012} \\
Conservation Biology Program, Fisheries and Wildlife Department
...
\textbf{Beck, M.W.}, Murrell, M.C., Hagy, J.D. {\bf In prep}. Improving estimates of estuary metabolism with time series of dissolved oxygen. Intended: \textit{Limnology and Oceanography: Methods}.
...
\textbf{Beck, M.W.} 2006. Reproductive characteristics of the green treefrog \textit{Hyla cinerea}: effects of agricultural contaminants. Honors Thesis. University of Florida.
