...
\item \textbf{Beck, M.W.}, Flaherty-Walia, K.E., Scolaro, S., Burke, M.C., Furman, B.T., Karlen, D.J., Pratt, C., Anastasiou, C.J., Sherwood, E.T. \textbf{In review}. Hot and fresh: evidence of climate-related supoptimal conditions for seagrass in a large Gulf coast estuary. \textit{Estuaries and Coasts}.

\item Simmons, B.A., \textbf{Beck, M.W.}, Flaherty-Walia, K.E., Lewis, J., Sherwood, E.T. \textbf{In review}. A murky ruling threatens the fate of millions of us wetlands. \textit{Wetlands}. 
...
\item \textbf{Beck, M.W.}, Arriola, J.M., Herrmann, M., Najjar, R.G. \textbf{In review}. Fitting metabolic models to dissolved oxygen data: The Estuarine BAyesian Single-station Estimation method (EBASE). \textit{Limnology and Oceanograpy: Methods}.

\item Skripnikov, A., Tania, R., Neffati, F., Adkins, M., \textbf{Beck, M.W.} \textbf{In review}. Twitter user account classification to gain insights into communication dynamics and public awareness during Tampa Bay's red tide events. \textit{FLAIRS-37: The 37th International Conference on the Florida Artificial Intelligence Research Society}.
...
\item Bednar\v{s}ek, N., Pelletier, G., \textbf{Beck, M.W.}, Feely, R., Siegrist, Z., Kiefer, D., Davis, J., Peadoby, B. \textbf{In review}. Predictable patterns within the kelp forest can indirectly create temporary refugia for ocean acidification. \textit{Science of the Total Environment}.
