...
{\bf Workshop Instructor} \hfill {\bf Jul. 2026}\\
SWFWMD R training, Brooksville, FL ({\footnotesize\href{https://tbep-tech.github.io/swfwmd-r-training}{link}})

{\bf Workshop Instructor} \hfill {\bf Nov. 2025}\\
Introduction to R, Biennial meeting of the Coastal and Estuarine Research Federation, Richmond, Virginia ({\footnotesize\href{https://tbep-tech.github.io/cerf-r-workshop/}{link}})

{\bf Workshop Co-Instructor} \hfill {\bf Mar. 2025}\\
Actionable Data with Shiny Dashboards, Biennial meeting of the National Water Quality Monitoring Conference, Green Bay, Wisconsin ({\footnotesize\href{https://tbep-tech.github.io/nwqmc-shiny/}{link}})

{\bf Doctoral Dissertation Committee, J. Shi} \hfill {\bf 2024 - 2025} \\
...
{\bf Masters Thesis Committee, C. Bryant} \hfill {\bf 2024 - 2025} \\
Committee Member for Masters Student, College of Marine Science, University of South Florida

{\bf Workshop Co-Instructor} \hfill {\bf Nov. 2023}\\
...
{\bf Workshop Instructor} \hfill {\bf May 2023}\\
...
{\bf Workshop Co-Instructor} \hfill {\bf Mar. 2023}\\
MassWateR R training, Essex, MA ({\footnotesize\href{https://massbays-tech.github.io/intro-to-r/}{link}})

{\bf Workshop Co-Instructor} \hfill {\bf Feb. 2023}\\
Open Science: Hands On, In Person Training for Natural Resource Managers, SWFWMD Tampa Service Office ({\footnotesize\href{https://tbep-tech.github.io/tbep-os-workshop/}{link}})

{\bf Remote Workshop Co-Instructor} \hfill {\bf Nov. 2021}\\
...
2026: \textit{BioScience} $\bullet$ \textit{Ecological Modelling} $\bullet$ \textit{Ecology and Evolution} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Environmental Monitoring and Assessment} $\bullet$ \textit{Estuaries and Coasts}$\bullet$ \textit{Frontiers in Marine Science} (2) $\bullet$ \textit{Limnology and Oceanography} $\bullet$ \textit{Ocean and Coastal Management} $\bullet$ \textit{PLOS Ecosystems}

2025: \textit{BioScience} $\bullet$ \textit{Environmental Data Science} $\bullet$ \textit{Environmental Science \& Technology} (2) $\bullet$ \textit{Estuaries and Coasts} (2) $\bullet$ \textit{Estuarine, Coastal and Shelf Science} $\bullet$ \textit{Journal of Geophysical Research - Oceans} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Restoration Ecology}

2024: \textit{Biodiversitas} $\bullet$ \textit{Environmental Monitoring and Assessment} $\bullet$ \textit{Environmental Science \& Pollution Research} (2) $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{Geoscience Data Journal} $\bullet$ \textit{Journal of Open Source Software} $\bullet$ \textit{Landscape Ecology} $\bullet$ \textit{Science of the Total Environment}

2023: \textit{Environmental Science \& Technology} $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{F1000} $\bullet$ \textit{Frontiers in Marine Science} (2) $\bullet$ \textit{Limnology \& Oceanography} $\bullet$ \textit{Marine Pollution Bulletin} $\bullet$ \textit{PeerJ} $\bullet$ \textit{Regional Studies in Marine Science}

2022: \textit{Estuaries and Coasts} $\bullet$ \textit{Frontiers in Environmental Science} (3) $\bullet$ \textit{Heliyon} $\bullet$ \textit{Journal of Environmental Management} $\bullet$ \textit{Water Research}

2021: \textit{Environmental Science \& Technology} $\bullet$ \textit{Freshwater Science} $\bullet$ \textit{Frontiers in Ecology and Evolution} $\bullet$ \textit{Marine Pollution Bulletin} (2) $\bullet$ \textit{PLOS Computational Biology} $\bullet$ \textit{rOpenSci} $\bullet$ USEPA Office of Research and Development

2020: \textit{Aquatic Sciences} $\bullet$ \textit{Coastal Management} $\bullet$ \textit{Ecological Modelling} (2) $\bullet$ \textit{Journal of Environmental Management} $\bullet$ \textit{Journal of Statistical Software} $\bullet$ \textit{Journal of the American Water Resources Association} $\bullet$ \textit{Marine Chemistry}

2019: \textit{Chemosphere} $\bullet$ \textit{Ecological Indicators} $\bullet$ \textit{Environmental Science \& Technology} $\bullet$ \textit{Environments} $\bullet$ \textit{Expert Systems with Applications} $\bullet$ \textit{Freshwater Science} $\bullet$ \textit{Frontiers in Ecology and the Environment} $\bullet$ \textit{New Zealand Journal of Marine and Freshwater Research}

2018: \textit{Aquatic Ecology} $\bullet$ \textit{Aquatic Sciences} $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{PeerJ} $\bullet$ \textit{Scientific Reports} $\bullet$ \textit{Thalassas}

2017: \textit{Estuarine, Coastal and Shelf Science} $\bullet$ \textit{Frontiers in Plant Science} $\bullet$ \textit{Geocarto International} $\bullet$ \textit{ISPRS Journal of Photogrammetry and Remote Sensing} $\bullet$ \textit{Lake and Reservoir Management} (2) $\bullet$ \textit{Remote Sensing}

2016: \textit{Ecological Modelling} $\bullet$ \textit{Engineering Computations} $\bullet$ \textit{Estuarine, Coastal and Shelf Science} (2) $\bullet$ \textit{North American Journal of Fisheries Management} $\bullet$ \textit{Remote Sensing} (2) $\bullet$ \textit{rOpenSci} $\bullet$ \textit{The R Journal} (3) $\bullet$ \textit{Water Research}

2015: \textit{Acta Oecologica} $\bullet$ \textit{Aquatic Sciences} $\bullet$ \textit{Environmental Modelling \& Software} $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{Journal of Applied Phycology} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Remote Sensing} $\bullet$ USEPA Office of Research and Development $\bullet$ \textit{Water Research}

2014: \textit{Aquatic Botany} $\bullet$ Elsevier book chapter $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Marine Ecology} $\bullet$ \textit{Marine Pollution Bulletin} $\bullet$ \textit{Remote Sensing} $\bullet$ USEPA Office of Research and Development

2013: \textit{Development in Practice} $\bullet$ \textit{International Journal of River Basin Management} $\bullet$ \textit{International Journal of Tropical Biology and Conservation} $\bullet$ \textit{Lake and Reservoir Management} $\bullet$ \textit{Limnology \& Oceanography}

2012: \textit{Development in Practice} $\bullet$ \textit{Ecological Research} $\bullet$ \textit{Hydrobiologia} $\bullet$ \textit{North American Journal of Fisheries Management}

2011: \textit{Aquatic Botany} $\bullet$ \textit{Journal of the North American Benthological Society} $\bullet$ Minnesota Department of Natural Resources $\bullet$ \textit{North American Journal of Fisheries Management} $\bullet$ \textit{Polar Biology} $\bullet$ \textit{Science of the Total Environment}

2010: \textit{Ecological Indicators} $\bullet$ \textit{Environmental Management} $\bullet$ \textit{North American Journal of Fisheries Management}

{\bf Scientific Program Committee Co-Chair} \hfill {\bf Jan. 2024 - Present} \\
2025 Coastal and Estuarine Research Federation biennial meeting
...
\item Alam, M.S., \textbf{Beck, M.W.}, Fleischer, C., Albaghdadi, M., Eke, R., Chen, Z., Elshall, A.S., Ye, M., Homandberg, M., Khraishah, H., Parsons, M. \textbf{In review}. Harmful algal bloom exposure and human health in the Gulf of Mexico: Targeted meta-analysis and integrated evidence synthesis. \textit{Communications Earth \& Environment}.

\item Alam, M.S., \textbf{Beck, M.W.}, Loughran, B., Mao, W., Chen, G. \textbf{In review}. Long-term nutrient-trends along the St. John's River-Estuary continuum: Integrating flow, salinity, and watershed-pressure context. \textit{Ecological Indicators}.

\item Best, B., Murray, T., Otis, D., Montes, E., Canonico, G., Ranganathan, J., Caldow, C., Diorio, M., Lima, A., Soares, J., \textbf{Beck, M.W.}, Satterthwaite, E., White, T., Biddle, M., McEachron, L., Kilborn, J., Muller-Karger, F. \textbf{In review}. Coding ocean indicators: Patterns and people. \textit{Progress in Physical Oceanography}.

\item Yang, B., Liu, Y., Law, J.A., Weisberg, R.H., D'Angelo, S., \textbf{Beck, M.W.}, Sherwood, E.T., Frazer, T.K. \textbf{In review}. Tampa Bay Observing Network (TBON): A continuous data acquisition system in support of science and environmental management. \textit{Environmental Monitoring and Assessment}.

\item Shi, J., Barnes, B., Muller-Karger, F., \textbf{Beck, M.W.}, Murawski, S., Liu, Y., Hu, C. \textbf{In review}. Water surface temperature trends in lakes and estuaries: Seasonal and decadal variations across Earth's hemispheres. \textit{Limnology and Oceanography}.
...
\item de Valpine, P., Foley, M., \textbf{Beck, M.W.}, Senn, D.B. \textbf{In press}. Additive mixed meta-analysis with spline meta-regression for nonlinear ecological trends. \textit{Ecology}.

\item \textbf{Beck, M.W.}, Sherwood, E.T., Murphy, R.R., Flaherty-Walia, K.E., Zhang, Q., Simmons, B.A., Burke, M.C. 2026. Managing the unmanageable: Understanding the competing effects of salinity and nutrient loading on estuarine water quality. \textit{Estuaries and Coasts}. 49(178):1-21. ({\footnotesize\href{https://doi.org/10.1007/s12237-026-01792-5}{10.1007/s12237-026-01792-5}}) 

\item Yang, B., Liu, Y., Weiyi, T., Law, J., Weisberg, R., \textbf{Beck, M.W.}, Sherwood, E.T., Frazer, T. 2026. A machine learning model for real-time total nitrogen monitoring in Tampa Bay. \textit{Marine Pollution Bulletin}. 233:120184. ({\footnotesize\href{https://doi.org/10.1016/j.marpolbul.2026.120184}{10.1016/j.marpolbul.2026.120184}}) 
 
\item Arriola, J.M., Najjar, R.G., Brice\~{n}o, H., Hu, C., Herrmann, M., \textbf{Beck, M.W.}. 2025. Ecosystem metabolic rates estimated from diel oxygen measurements in two subtropical estuaries. \textit{Estuaries and Coasts}. 48:155. ({\footnotesize\href{https://doi.org/10.1007/s12237-025-01597-y}{10.1007/s12237-025-01597-y}})

\item Lizcano-Sandoval, L., \textbf{Beck, M.W.}, Scolaro, S., Sherwood, E.T., Muller-Karger, F.E. 2025. Cloud-based satellite remote sensing for enhancing seagrass monitoring and ecosystem management. \textit{ISPRS Journal of Photogrammetry and Remote Sensing}. 227:508-518. ({\footnotesize\href{https://doi.org/10.1016/j.isprsjprs.2025.06.034}{10.1016/j.isprsjprs.2025.06.034}})

\item Neffati, F., Skripnikov, A., Jackson, S., Roy, T. \textbf{Beck, M.W.}. 2025. Tampa Bay Red Tide Tweet Dashboard: Using Twitter/X to Inform Understanding of Harmful Algal Blooms in the Tampa Bay Region. \textit{SoftwareX}. 30:102160. ({\footnotesize\href{https://doi.org/10.1016/j.softx.2025.102160}{10.1016/j.softx.2025.102160}}) 
...
\item \textbf{Beck, M.W.}, Flaherty-Walia, K.E., Scolaro, S., Burke, M.C., Furman, B.T., Karlen, D.J., Pratt, C., Anastasiou, C.J., Sherwood, E.T. 2024. Hot and fresh: evidence of climate-related suboptimal water conditions for seagrass in a large Gulf coast estuary. \textit{Estuaries and Coasts}. 47:1475-1497. ({\footnotesize\href{https://doi.org/10.1007/s12237-024-01385-0}{10.1007/s12237-024-01385-0}}) 

\item Bednar\v{s}ek, N., Pelletier, G., \textbf{Beck, M.W.}, Feely, R., Siegrist, Z., Kiefer, D., Davis, J., Peabody, B. 2024. Predictable patterns within the kelp forest can indirectly create temporary refugia for ocean acidification. \textit{Science of the Total Environment}. 945:174065. ({\footnotesize\href{https://doi.org/10.1016/j.scitotenv.2024.174065}{10.1016/j.scitotenv.2024.174065}}) 
...
\item \textbf{Beck, M.W.}, Arriola, J.M., Herrmann, M., Najjar, R.G. 2024. Fitting metabolic models to dissolved oxygen data: The Estuarine BAyesian Single-station Estimation method (EBASE). \textit{Limnology and Oceanography: Methods}. 22(8):590-607. ({\footnotesize\href{https://doi.org/10.1002/lom3.10620}{10.1002/lom3.10620}})
...
\item Cramer, M.T., Radabaugh, K.R., \textbf{Beck, M.W.}, Flaherty-Walia, K.E., Ellis, W., Miller, C. 2025. Chapter 4 Tampa Bay, Coastal Habitat Integrated Mapping and Monitoring Program Report for the State of Florida No. 2. Florida Fish and Wildlife Conservation Commission, Fish and Wildlife Research Institute, Technical Report No. 21, Version 2. St. Petersburg, FL. ({\footnotesize\href{https://myfwc.com/media/iotl3mpa/chimmp-v2-ch04.pdf}{link}})

\item Ambrose, R., Baker, J., \textbf{Beck, M.W.}, Lopez-Carr, D., Davis, A.L., Izbicki, J., Marshall, L., Noble, R., Ridgeway, I., Sanders, B., Sharp, G., Wadzuk, B. 2024. Southern California Stormwater Monitoring Coalition: Five-year research agenda 2024-2029.  Technical Report. Southern California Coastal Water Research Project. Costa Mesa, CA.

\item Craig, C.A., Radabaugh, K.R., \textbf{Beck, M.W.}, Flaherty-Walia, K.E., Sherwood, E.T. 2024. Tampa Bay habitat protection and restoration opportunities, as identified using analysis of NOAA Coastal Change Analysis Program (C-CAP) land cover maps. Tampa Bay Estuary Program Technical Report \#17-24. St. Petersburg, FL. ({\footnotesize\href{https://drive.google.com/file/d/1gllsxxPoFx7X59dV91yyWgUD9SF99chn/view}{link}})
...
\item DeValpine, P., \textbf{Beck, M.W.} 2026. splinemixmeta: Additive mixed-meta analysis with spline meta-regression. v1.0.1. CRAN R package. ({\footnotesize\href{https://cran.r-project.org/web/packages/splinemixmeta/index.html}{link}})
    
\item Payton, Q., Olsen, T., Weber, M., McManus, M., Kincaid, T., \textbf{Beck, M.W.} 2026. micromap: Linked micromap plots, v1.9.12. CRAN R package. ({\footnotesize\href{https://cran.r-project.org/web/packages/micromap/index.html}{link}})
    
\item \textbf{Beck, M.W.}, Carr, J. Wetherill, B. 2026. MassWateR: Tools for QAQC and Exploratory Analysis of Massachusetts Surface Water Quality Data, v2.2.1. CRAN R package. ({\footnotesize\href{https://massbays-tech.github.io/MassWateR/}{link}})
    
\item \textbf{Beck, M.W.} 2026. WRTDStidal: Weighted regression for water quality evaluation in tidal waters, v1.1.5. CRAN R package. ({\footnotesize\href{https://cran.r-project.org/web/packages/WRTDStidal/index.html}{link}})
 
\item \textbf{Beck, M.W.}, de Valpine, P., Murphy, R., Wren, I., Chelsky, A., Foley, M., Senn, D.B. 2026. wqtrends: Assess Water Quality Trends with Generalized Additive Models, v1.5.2. CRAN R package. ({\footnotesize\href{https://tbep-tech.github.io/wqtrends/}{link}})

\item \textbf{Beck, M.W.}, Villarroel, P., Padfield, D., Gaborini, L., von Maltzahn, N. 2026. rStrava: Functions to access data from Strava's v3 API, v1.3.4. CRAN R package. ({\footnotesize\href{https://cran.r-project.org/web/packages/rStrava/index.html}{link}})

\item \textbf{Beck, M.W.} 2025. SWMPr: An R package for the National Estuarine Research Reserve System, v2.5.2. CRAN R package. ({\footnotesize\href{http://fawda123.github.io/SWMPr}{link}})

\item \textbf{Beck, M.W.}, Schrandt, M., Wessel, M., Sherwood, E., Raulerson, G., Prasad, A.A.B, Best, B., Cressman, K. 2025. tbeptools: Data and Indicators for the Tampa Bay Estuary Program, v3.1.0. R package. ({\footnotesize\href{https://tbep-tech.github.io/tbeptools/}{link}})

\item \textbf{Beck, M.W.}, Perepolkin, D. 2025. Jabbrev: Convert journal names from long to short formats, v1.0.0. R package. ({\footnotesize\href{https://github.com/fawda123/Jabbrev}{link}})
...
\item {\bf Beck, M.W.} 2026. Interrogating long-standing management paradigms for Tampa Bay: Is the status quo good enough? \textit{Oral presentation}. Florida Lake Management Society 37th Annual Technical Symposium, Bonita Springs, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1xpe7q04KHqY3tUAAWXZwniF3f0w_T6MmJy5UwMfgx6I/edit?usp=drive_link}{link}})

\item {\bf Beck, M.W.} 2026. Evaluating the management paradigm for Tampa Bay: What's old is new? \textit{Oral presentation}. Florida Association of Water Quality Control Annual Conference, Naples, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1Buq_BkGJ1JYCqPPVYDPCFXO6LZLn2kH-aveQmizAu_U/edit?usp=drive_link}{link}})

\item {\bf Beck, M.W.} 2026. From data to action: Making informed decisions to protect and restore Tampa Bay. \textit{Oral presentation}. University of South Florida, Environmental \& Water Resources Engineering Departmental Seminar, Tampa, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1DfKkQU7s0_VTo7p3icq8zAt8iaZ9E1f7UUFsHmUiarw/edit?usp=sharing}{link}})

\item {\bf Beck, M.W.} 2026. Nutrient management policy for Tampa Bay. \textit{Oral presentation}. University of South Florida, College of Marine Science Ocean Policy (OCE 6085) lecture, St. Petersburg, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1my11_INS59pDJ2zVRrgaaTgzGfihLYgj/edit?usp=sharing&ouid=111030724967489561225&rtpof=true&sd=true}{link}})

\item {\bf Beck, M.W.} 2025. Piney Point, red tide, and Twitter: A Tampa Bay story. \textit{Oral presentation}. New College of Florida, Data Science Departmental Seminar, Sarasota, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1X0T6_zcCld4mYPsuJ5rOKRXGfRLH8B5tuXgMLmtvZ-E/edit?usp=sharing}{link}})

\item {\bf Beck, M.W.} 2025. From science to action: Meaningfully addressing climate change in conventional management paradigms for Estuaries of National Significance. \textit{Keynote presentation}. Indian River Lagoon Symposium, Harbor Branch Oceanographic Institute, Fort Pierce, FL. ({\footnotesize\href{https://docs.google.com/presentation/d/1NyJmPY7wL00SsGyN4EMLyvWimSKsG8ZfODNXctcTSR4/edit?usp=sharing}{link}})
...
\item {\bf Beck, M.W.}, Arriola, J.M., Herrmann, M., Najjar, R. 2023. Fitting metabolic models to dissolved oxygen data: The Estuarine BAyesian Single-station Estimation method. \textit{Oral presentation}. Coastal and Estuarine Research Federation biennial meeting, Portland, OR. 
...
\item Medina, M., \textbf{Beck, M.W.}, Hecker, J., Iadevaia, N., Moody, B., Anastasiou, C., Tomasko, D., Milbrandt, E.C., Kaplan, D., Angelini, C. 2025. Leveraging long-term water quality data for assessment of the Greater Charlotte Harbor system. \textit{Oral presentation}. Coastal and Estuarine Research Federation biennial meeting, Richmond, VA. 
    
\item {\bf Beck, M.W.} 2025. Data 911: How Posit can support decision-makers in times of environmental crisis. \textit{Oral presentation}. Posit::conf(2025), Atlanta, GA. ({\footnotesize\href{https://docs.google.com/presentation/d/1YbIg30Jl_tglag10_retKKTet-i524yyAJDW6rAHL8Q/edit?usp=sharing}{link}})

\item {\bf Beck, M.W.}, Best, B.D., Burke, M.C., Sherwood, E.T. 2025. Downscaling climate change indicators: Using global phenomena to inform regional decision-making. \textit{Oral presentation}. National Water Quality Monitoring Conference biennial meeting, Green Bay, WI. ({\footnotesize\href{https://docs.google.com/presentation/d/1LCdSZplNNUcMLxklvXwFyxERZxC1FQXQUUeaQYKVQGg/edit?usp=sharing}{link}})
...
\item Arriola, J.M., {\bf Beck, M.W.}, Bourque, E., Caffrey, J., Herrmann, M., Najjar, R.G. 2021. Improving estuarine net ecosystem production estimates with detiding: Revisiting twenty years of data at Apalachicola. \textit{Oral presentation}. Coastal and Estuarine Research Federation Virtual Meeting.
...
\item {\bf Beck, M.W.}, Tomcko, C.M., Valley, R.D., and Staples, D.F. 2014. Analysis of macrophyte indicator variation as a function of sampling, temporal, and stressor effects. \textit{Poster presentation}. Joint Aquatic Sciences Meeting, Portland, OR.
...
Choctawhatchee Basin Alliance (NFSC) Contract No. P2500899 {\bf \$14850} \hfill {\bf Apr. 2025} \\
San Francisco Estuary Institute Contract No. 1571 {\bf \$12000} \hfill {\bf Mar. 2023} \\
USEPA ORD, Level III Science and Technological Achievement Award \hfill {\bf Jun. 2022} \\
San Francisco Estuary Institute Contract No. 1571 {\bf \$9600} \hfill {\bf Jan. 2022} \\
...
Workshop participant, Extending Quarto, Posit::conf(2025), Atlanta, GA \\
