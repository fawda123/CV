...
2026: \textit{BioScience} $\bullet$ \textit{Ecology and Evolution} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Frontiers in Marine Science} $\bullet$ \textit{Ocean and Coastal Management}
...
\item de Valpine, P., Foley, M., \textbf{Beck, M.W.}, Senn, D.B. \textbf{In review}. Additive mixed meta-analysis with spline meta-regression for nonlinear ecological trends. \textit{Ecology}.
