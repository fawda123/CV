...
\item \textbf{Beck, M.W.}, Murphy, R. {\bf In review}. Comparison of weighted regression and additive models for trend evaluation of water quality in tidal waters. \textit{Journal of the American Water Resources Association}.
...
\item Bajer, P.G., \textbf{Beck, M.W.}, Cross, T.K., Koch, J., Bartodziek, B., Sorensen, P.W. {\bf In review}. Biological invasion by a benthivorous fish reduced the cover and species richness of aquatic plants in most lakes of a large North American ecoregion. \textit{Global Change Biology}. 

\item Le, C., Lehrter, J.C., Schaeffer, B.A., Hu, C., Murrell, M.C., Hagy, J.D., Greene, R.M., \textbf{Beck, M.W.} {\bf In press}. Bio-optical water quality dynamics observed from MERIS in Pensacola Bay, Florida. \textit{Estuarine, Coastal and Shelf Science}.
...
\vspace{\baselineskip} 
\centerline{\large{\textit{Software and Websites}}}
...
\item \textbf{Beck, M.W.} 2015. WtRegDO: Supplementary package to support the manuscript ``Improving estimates of ecosystem metabolism by reducing the effects of tidal advection on dissolved oxygen time series'', v0.0.6.9000. R package. (\href{http://github.com/fawda123/WtRegDO}{link})

\item \textbf{Beck, M.W.} 2015. WRTDStidal: Evaluating long-term chlorophyll trends in tidal waters, v0.0.28.9000. R package. (\href{https://github.com/fawda123/wtreg_for_estuaries}{link})
...
\item \textbf{Beck, M.W.} 2015. Trends in SWMP parameters. Shiny Web Application. (\href{
http://beckmw.shinyapps.io/swmp_comp/}{link})

\item \textbf{Beck, M.W.} 2015. Monthly and annual summary of SWMP parameters. Shiny Web Application. (\href{
http://beckmw.shinyapps.io/swmp_summary/}{link})

\item \textbf{Beck, M.W.} 2015. SWMPr: An R package for the National Estuarine Research Reserve System, v2.1.4. R package. (\href{http://cran.r-project.org/web/packages/SWMPr/}{link})
...
\item {\bf Beck, M.W.}, Hagy, J.D. 2014. Adaptation of a weighted regression approach to evaluate water quality trends in {T}ampa {B}ay, {F}lorida. \textit{Oral presentation}. National Water Quality Monitoring Council annual meeting, Cincinnati, OH.
