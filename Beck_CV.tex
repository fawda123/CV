...
2026: \textit{BioScience} $\bullet$ \textit{Ecological Modelling} $\bullet$ \textit{Ecology and Evolution} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Estuaries and Coasts}$\bullet$ \textit{Frontiers in Marine Science} (2) $\bullet$ \textit{Limnology and Oceanography} $\bullet$ \textit{Ocean and Coastal Management} $\bullet$ \textit{PLOS Ecosystems}
