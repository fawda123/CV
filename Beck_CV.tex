...
2026: \textit{BioScience} $\bullet$ \textit{Ecological Modelling} $\bullet$ \textit{Ecology and Evolution} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Estuaries and Coasts}$\bullet$ \textit{Frontiers in Marine Science} (2) $\bullet$ \textit{Ocean and Coastal Management}
...
\item Yang, B., Liu, Y., Weiyi, T., Law, J., Weisberg, R., \textbf{Beck, M.W.}, Sherwood, E.T., Frazer, T. \textbf{In review}. A machine learning model for real-time total nitrogen monitoring in Tampa Bay. \textit{Marine Pollution Bulletin}.

\item \textbf{Beck, M.W.}, Sherwood, E.T., Murphy, R.R., Flaherty-Walia, K.E., Zhang, Q., Simmons, B.A., Burke, M.C. \textbf{In review}. Managing the unmanageable: Understanding the competing effects of salinity and nutrient loading on estuarine water quality. \textit{Estuaries and Coasts}.    
