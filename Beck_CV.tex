...
2024: \textit{Biodiversitas} $\bullet$ \textit{Environmental Monitoring \& Assessment} $\bullet$ \textit{Environmental Science \& Pollution Research} (2) $\bullet$ \textit{Estuaries and Coasts} $\bullet$ \textit{Geoscience Data Journal} $\bullet$ \textit{Journal of Open Source Software} $\bullet$ \textit{Landscape Ecology} $\bullet$ \textit{Science of the Total Environment}
...
\item Yang, B., Liu, Y., Law, J.A., Weisberg, R.H., D'Angelo, S., \textbf{Beck, M.W.}, Sherwood, E.T., Frazer, T.K. \textbf{In review}. Tampa Bay Observing Network (TBON): A continuous data acquisition system in support of science and environmental management. \textit{Estuaries and Coasts}.
