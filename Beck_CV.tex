...
\item \textbf{Beck, M.W.}, Schrandt, M.N., Wessel, M.R., Sherwood, E.T., Raulerson, G.E., Prasad, A.A.B., Best, B.D. \textbf{In review}. tbeptools: An R package for synthesizing estuarine data for environmental research. \textit{Journal of Open Source Software}.

\item \textbf{Beck, M.W.}, de Valpine, P., Murphy, M., Wren, I., Chelsky, A., Foley, M., Senn, D.B. \textbf{In review}. Multi-scale trend analysis of water quality using error propagation of generalized additive models. \textit{Science of the Total Environment}. 
...
\item Rogers, J.B., Stein, E.D., \textbf{Beck, M.W.}, Flint, K., Kinoshita, A.M., Ambrose, R.F., \textbf{In press}. Modeling future changes to the hydrological and thermal regime of unaltered streams using projected changes in climate. \textit{Ecohydrology} ({\footnotesize\href{https://doi.org/10.1002/eco.2299}{10.1002/eco.2299}})
