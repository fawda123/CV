...
\item Bokde, N., Mart\'{i}nez-\'{A}lvarez, F., \textbf{Beck, M.W.}, Kulat, K.D. {\bf In review}. A novel imputation methodology for time series based on pattern sequence forecasting. \textit{International Journal of Forecasting}. 

\item Bokde, N., \textbf{Beck, M.W.} , Asencio-Cort\'{e}s, G., Kulat, K.D. {\bf In review}. A simple softare package to compare and visualize prediction accuracy of imputation methods. \textit{IEEE Transactions on Visualization and Computer Graphics}. 
