...
2026: \textit{BioScience} $\bullet$ \textit{Ecology and Evolution} $\bullet$ \textit{Elementa: Science of the Anthropocene} $\bullet$ \textit{Estuaries and Coasts}$\bullet$ \textit{Frontiers in Marine Science} $\bullet$ \textit{Ocean and Coastal Management}
