...
\item Applies statistical trend models (wqtrends, WRTDStidal) to convert raw monitoring data into actionable indicators of ecosystem condition for restoration managers, directly analogous to the proposed acoustic Resilience Score framework.
